...
class TestQuery(unittest.TestCase):
    ...
    def test_query_approaches_with_distance_velocity_bounds_max_diameter(
            self):
        start_date = datetime.date(2020, 3, 1)
    ...
    def test_query_approaches_in_spring_with_distance_velocity_diameter_bounds(
            self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
    ...
    def test_query_approaches_with_all_bounds_potentially_hazardous_neos(
            self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
    ...
    def test_query_approaches_with_all_bounds_not_potentially_hazardous_neos(
            self):
        start_date = datetime.date(2020, 3, 1)
        end_date = datetime.date(2020, 5, 31)
        distance_max = 0.5
